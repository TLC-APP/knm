 ...
 *  			
 */			
		'window_url' => Router::url('/',true).'chapters/elfinder',		// call elfinder window
		'connector_url' => Router::url('/',true).'chapters/connector',	// connect to retrive files
		'locale' => 'vi', 
		...
		'options' => array(
			...
			'roots' => array(
				array(
					...
					'URL'   		=> Router::url('/',true).'img/upload',	// upload main folder
