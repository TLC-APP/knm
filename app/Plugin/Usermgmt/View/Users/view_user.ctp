                    ...
                    <td class="dong_hoc_phi_td"><?php
                        ...
                        if (!is_null($enroll['pass']) && !$enroll['pass']) {
                            if ($enroll['fee']) {
                                ...
                                $fee = $this->Html->link("<i class='fa fa-times text-danger'></i>", array('controller' => 'enrollments', 'action' => 'dong_hoc_phi', $enroll['id']), array('class' => 'dong_hoc_phi_btn', 'escape' => false));
                            }
                            echo $fee;
                        }
                        ?></td>
