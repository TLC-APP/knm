<?php
App::uses('DepartmentsChaptersController', 'Controller');

/**
 * DepartmentsChaptersController Test Case
 *
 */
class DepartmentsChaptersControllerTest extends ControllerTestCase {
