...
<table id="grid-lop-het-han"></table>
<div id="lop-het-han-grid-pager"></div>
<script type="text/javascript">

    jQuery(function($) {
        var grid_selector = "#grid-lop-het-han";
        var pager_selector = "#lop-het-han-grid-pager";
        ...
        jQuery(grid_selector).jqGrid({
            //direction: "rtl",
            rownumbers: true,
            url: '<?php echo SUB_DIR . '/manager/courses/lop_het_han' ?>',
            datatype: "json",
            ...
            colModel: [
                ...
                {name: 'chapter', index: 'chapter', width: '200', search: false},
                {name: 'start', index: 'start', width: '100', formatter: 'date', search: false},
                {name: 'teacher', width: '100', index: 'teacher', search: false},
                {name: 'enrollno', width: '100', index: 'enrollno', search: false},
                {name: 'trang_thai', width: '100', index: 'trang_thai', search: false}
            ],
            viewrecords: false,
            rowNum: 10,
            rowList: [5, 10, 20, 30],
            ...
            caption: "Các lớp hết hạn không đủ số lượng mở lớp"
        });
