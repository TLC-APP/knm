                ...
                <div class="">
                    <table class="table table-condensed">
                        <tbody>
                            ...
                            <tr><td>Đã đăng ký</td><td><?php echo h($course['Course']['enrolledno']); ?></td></tr>
                            ...
                            <tr>
                                ...
                                <td<?php echo $this->Html->link($course['Teacher']['name'], array('controller' => 'users', 'action' => 'view', $course['Teacher']['id'])); ?>
                            </td></tr>
                    </tbody>
                </table>
            </div>
                ...
                <?php if (!empty($course['Enrollment'])): ?>
                    <table class="table table-condensed">
                        ...
                        foreach ($course['Enrollment'] as $enrollment):
                            ...
                            <tr>
                                <td><?php echo $stt++; ?></td>
                                <td><?php echo $enrollment['Student']['username']; ?></td>
...
<div class="pull-right">
    <?php echo $this->Html->link('Trở lại', array('action' => 'index'), array('escape' => false, 'class' => 'btn btn-info')); ?>
    <?php echo $this->Html->link('Cập nhật', array('action' => 'edit', $course['Course']['id']), array('escape' => false, 'class' => 'btn btn-info')); ?>
